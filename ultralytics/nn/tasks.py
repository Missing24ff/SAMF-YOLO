...
from ultralytics.nn.modules.UniRepLknet import *
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            PSA,
            SCDown,
            C2fCIB,C3k2_BFAM_1,C3k2_BFAM_2
        }:
            c1, c2 = ch[f], args[0]
            ...
            if m is C3k2:  # for M/L/X sizes
                ...
                if scale in "mlx":
                    args[3] = True
        elif m in {'unireplknet_a', 'unireplknet_f', 'unireplknet_p', 'unireplknet_n'}:
            m = m(*args)
            backbone = True
            c2 = m*width_list
